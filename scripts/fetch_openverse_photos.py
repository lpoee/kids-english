...
ADJ_SELECTIONS = {
    ...
    "wide": {"query": "wide road photo", "index": 1},
    "narrow": {"query": "narrow path photo", "index": 1},
...
COLOR_SELECTIONS = {
    "red": {"query": "red ball photo", "index": 1},
    "blue": {"query": "blue cup photo", "index": 1},
    "green": {"query": "green leaf photo", "index": 1},
    "yellow": {"query": "yellow banana photo", "index": 1},
    "orange_color": {"query": "orange fruit photo", "index": 1},
    "purple": {"query": "purple balloon photo", "index": 1},
    "pink": {"query": "pink flower photo", "index": 1},
    "brown": {"query": "brown teddy bear photo", "index": 1},
    "gray": {"query": "gray elephant photo", "index": 1},
    "black": {"query": "black cat photo", "index": 1},
    "white": {"query": "white rabbit photo", "index": 1},
}
